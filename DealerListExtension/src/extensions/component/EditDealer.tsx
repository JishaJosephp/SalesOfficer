...
export default class EditDealer extends React.Component<IDealerProps, IDealerState> {
    ...
    public constructor(props: IDealerProps) {
        ...
        this.state = {
            ...
            Coordinates: props.Coordinatesprops,
            state: props.stateprops,
            location: props.Locationprops,
            permanentdealer:props.Permanentdealerprops,
            district: props.Districtprops,

            locationoption: props.locationoptionprops,

            districtoption: props.districtoptionprops,
            stateoption: [],
            mandatory: true
    ...
    public componentWillReceiveProps(nextProps, prevState) {
        if (nextProps.itemidprops !== prevState.itemidprops) {
            this.setState({
                ...
                district: nextProps.Districtprops,
                dealername: nextProps.DealerNameprops,
                contactnumber: nextProps.ContactNumberprops,
                location: nextProps.Locationprops,
                state: nextProps.stateprops,
                permanentdealer:nextProps.Permanentdealerprops,
                Address: nextProps.Addressprops,
                Coordinates: nextProps.Coordinatesprops,
                locationoption: nextProps.locationoptionprops,

                districtoption: nextProps.districtoptionprops
        ...
        if (this.state.dealername == "" || this.state.dealername == undefined ||
         this.state.Address == "" || this.state.Address == undefined ||
          ...
          || this.state.location == null || this.state.location == undefined) {
            ...
            if (conf == true) {
                let list = sp.web.lists.getByTitle("Dealer List");
